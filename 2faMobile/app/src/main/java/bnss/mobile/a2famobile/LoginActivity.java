...
*/
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            Callback<TokenResponse> cbTokenResponse = tokenResponseCallback(username, password);
    ...
    private Callback<TokenResponse> tokenResponseCallback(final String username, final String password)
    {
        return new Callback<TokenResponse>() {
            ...
            public void onResponse(Call<TokenResponse> call, Response<TokenResponse> response) {
              ...
              //          final Account account = new Account(username, "bnss.mobile.a2famobile");
                   ...
                   //     accountManager.addAccountExplicitly(account, password, null);
                        ...
                        changeToVerifiedView(access_token);
                        break;
                    case 401:
    ...
    // Exists this activiy and the root activity starts the verified view
    public void changeToVerifiedView(String access_token) {
